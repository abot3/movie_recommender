...
sim1 = proxy::simil(t(data), t(data), method = "cosine")
...
diag(sim1_mat) = 0.0 
s_mat = matrix(0, nrow = nrow(sim1_mat), ncol = ncol(sim1_mat))
...
newdata_prime = newdata
newdata_prime[is.na(newdata)] = 0
# r = t(t(s_mat) * newdata_prime)
r = t(s_mat) %*% newdata_prime
